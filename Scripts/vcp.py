"""VCP — Action Desk primary #3 (former Manas Focus gates; fine-tune later).

Note: named VCP by desk lock — current gates are ema_shakeout + 3M force + purple density,
not classic Minervini successive-contraction geometry yet.
