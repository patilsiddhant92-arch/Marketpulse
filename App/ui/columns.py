...
GLOBAL_COLUMNS: dict[str, ColumnContract] = {
    ...
    "rs_vs_nifty_21d": ColumnContract("rs_vs_nifty_21d", "VS NIFTY 21D", 180, 160, align="right", format_type="numeric", group="Setup"),
    "rs_vs_nifty_63d": ColumnContract("rs_vs_nifty_63d", "VS NIFTY 63D", 180, 160, align="right", format_type="numeric", group="Setup"),
    ...
    "turnover_share_delta_1d": ColumnContract("turnover_share_delta_1d", "Δ SHARE 1D", 92, 82, align="right", format_type="pct", group="Flow"),
    "turnover_share_delta_5d": ColumnContract("turnover_share_delta_5d", "Δ SHARE 5D", 92, 82, align="right", format_type="pct", group="Flow"),
    "adv_pct": ColumnContract("adv_pct", "ADV %", 78, 68, align="right", format_type="pct", group="Breadth"),
    "leader_symbols": ColumnContract("leader_symbols", "LEADERS", 260, 220, align="left", format_type="chips", group="Context"),
